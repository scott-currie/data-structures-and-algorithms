...
const sortMeetingsByDay = (arr) => {
  const dayKey = {'Monday': 0, 'Tuesday':1, 'Wednesday': 2, 'Thursday':3, 'Friday': 4};
  return arr.sort((a,b) => {
    return dayKey[a.dayOfWeek] > dayKey[b.dayOfWeek];
  });
};
...
const sortSchedule = (arr) => {
  let dayKey = {'Monday': 0, 'Tuesday':1, 'Wednesday': 2, 'Thursday':3, 'Friday': 4};
  return arr.sort((a,b) => {
